...
export class Authentication {
  ...
  // NOTE: For this application we have decided that
  ...
  /**
   * Boolean to determine if we are logged in and the token
   * is still valid. Even if we have a token we will still
   * have to reauthenticate if the token has expired.
   */
  ...
  /**
   * Retrieve the current user. This function should only be
   * called after the calling method has checked to make sure
